...
return [
    ...
    [
        ...
        'links' => [
            ...
            [
                'id' => 'datos_link_pinar',
                'url' => '/documentos/datos/Plan_Institucional_de_Archivos.pdf',
            ...
            [
                'id' => 'datos_link_politica_doc',
                'url' => '/documentos/datos/Politica_de_gestion_documental.pdf',
                'icon' => '/img/Iconos/politicas y lineamientos.svg',
                'label' => 'Política de Gestión Documental',
                'description' => 'Política institucional de gestión documental.',
            ],
            [
                'id' => 'datos_link_esquema',
                'url' => '/documentos/pdf/IDCBIS_Esquema_Publicaci%C3%B3n.pdf',
                'icon' => '/img/Iconos/politicas y lineamientos.svg',
            ...
            [
                'id' => 'datos_link_pgd',
                'url' => '/documentos/pdf/Programa_gestion_documental_v2.pdf',
                'icon' => '/img/Iconos/gestion.svg',
                'label' => 'Programa Gestión Documental (PGD)',
                'description' => 'Programa de gestión documental del instituto.',
            ],
            [
                'id' => 'datos_link_diagnostico',
                'url' => '/documentos/pdf/Diagnostico_Integral_de_Archivo.pdf',
                'icon' => '/img/Iconos/gestion.svg',
                'label' => 'Diagnóstico Integral de Archivos 2023',
                'description' => 'Diagnóstico integral de archivos del IDCBIS.',
            ],
            [
                'id' => 'datos_link_sic',
                'url' => '/documentos/pdf/Plan_de_Conservacion_Documental_VF.pdf',
